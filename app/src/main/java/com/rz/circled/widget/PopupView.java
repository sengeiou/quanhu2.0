...
import com.rz.circled.modle.OpusPriceModel;
...
public class PopupView implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    private CommonAdapter<OpusPriceModel> mPriceAdapter;
    ...
    public PopupView(Context mContext) {
        ...
        mAdapter = new CommonAdapter<String>(mContext, mItems, R.layout.popup_textview) {
            @Override
    ...
    public PopupView(Context mContext, String str) {
        ...
        mPriceAdapter = new CommonAdapter<OpusPriceModel>(mContext, mPrices, R.layout.adapter_price) {
            @Override
            public void convert(ViewHolder helper, OpusPriceModel item,int position) {
                ...
                if (item.isShowAllBtn()) {
                    mTxt.setVisibility(View.VISIBLE);
                    mLinear.setVisibility(View.GONE);
                } else {
                    mTxt.setVisibility(View.GONE);
                    mLinear.setVisibility(View.VISIBLE);
//                    mTxtPrice.setText(Currency.returnDollar(item.getPrice()).replace(mContext.getString(R.string.yuan), "").trim());
                }
