...
//        initViews(context);
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textSize != -1) {
            this.mTextSize = DensityUtils.px2sp(context, textSize);
        }
        //修改网格密码的分割线宽度0.5F
        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, DensityUtils.dip2px(getContext(), 0.5F));
    ...
    private void inflaterViews(Context context) {
        ...
        while (index < mPasswordLength) {
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.layout_gridpwd_textview, null);
