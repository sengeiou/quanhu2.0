...
//        helper.setText(R.id.tv_desc, item.getOwnerName() + "  " + item.getOwnerIntro());
        ...
        helper.setText(R.id.tv_from, String.format(mContext.getString(R.string.private_group_from_group), TextUtils.isEmpty(item.getCircleName()) ? "" : item.getCircleName()));
