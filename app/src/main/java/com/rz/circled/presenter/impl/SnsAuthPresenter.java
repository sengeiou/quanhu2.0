...
//        mUserService = Http.getUserService(mContext);
    ...
    public void loginRequest(String phone, String pw) {
        ...
        mView.onLoadingStatus(CodeStatus.Gegeneral.DATA_LOADING, mContext.getString(R.string.is_loading));
                ...
                if (response.isSuccessful()) {
                    ...
                    if (res.getRet() == ReturnCode.SUCCESS) {
                        ...
                        if (null != user) {
                            ...
                            mView.onLoadingStatus(CodeStatus.Gegeneral.DATA_SUCCESS_FULL, mContext.getString(R.string.login_success));
...
//                        }
                ...
                //登录失败
                mView.onLoadingStatus(CodeStatus.Gegeneral.ERROR_DATA, mContext.getString(R.string.login_fail));
            }
...
//                            mView.onLoadingStatus(CodeStatus.Gegeneral.DATA_SUCCESS_FULL, mContext.getString(R.string.bind_success));
//                        } else {
//                            mView.onLoadingStatus(CodeStatus.Gegeneral.DATA_SUCCESS_FULL, mContext.getString(R.string.unbind_card_success));
//                        }
...
//                //绑定或者解绑
//                if (action == Type.ACTION_BIND) {
//                    mView.onLoadingStatus(CodeStatus.Gegeneral.ERROR_DATA, mContext.getString(R.string.bind_fail));
//                } else {
//                    mView.onLoadingStatus(CodeStatus.Gegeneral.ERROR_DATA, mContext.getString(R.string.unbind_card_fail));
//                }
//            }
//
//            @Override
...
//            public void run() {
//                mView.onLoadingStatus(CodeStatus.Gegeneral.DATA_LOADING, mContext.getString(R.string.login_loading));
//            }
//        });
//        Call<ResponseData<UserInfoModel>> call = mUserService.otherLogin(
//                1004,
//                openId,
//                accessToken,
//                type,
...
//    }
//
//    public void delSinaToken() {
//        OkHttpClient client = new OkHttpClient();
//        String url = "https://api.weibo.com/oauth2/revokeoauth2";
////        String sinaRefreshAccessToken = Session.getSinaRefreshAccessToken();
//        String sinaAccessToken = Session.getSinaAccessToken();
////        if (!TextUtils.isEmpty(sinaRefreshAccessToken)) {
////            sinaAccessToken = sinaRefreshAccessToken;
////        }
////        Log.e("sinaAccessToken", sinaAccessToken + "");
//        RequestBody body = new FormBody.Builder()
//                .add("access_token", sinaAccessToken)
//                .build();
