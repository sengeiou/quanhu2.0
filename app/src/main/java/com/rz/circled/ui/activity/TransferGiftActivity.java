...
import com.rz.httpapi.bean.RewardGiftBean;
...
//    TextView mTxtNoMoney;
    ...
    //存储礼物adp
    List<CommonAdapter<RewardGiftBean>> mGiftAdps = new ArrayList<>();
    //存储viewpager的子布局
    List<View> mItemsView = new ArrayList<View>();

    //记录点击的礼物信息
    private RewardGiftBean mGifrModel;
    //打赏相关
...
//
    ...
    public static void startTransferGiftAty(Context context, TransferBean transferModule, boolean isCircle) {
...
//        v3CirclePresenter = new V3CirclePresenter();
...
//    }
    ...
    public void initView() {
        ...
        transferBean = (TransferBean) intent.getSerializableExtra(IntentKey.EXTRA_SERIALIZABLE);
...
//        List<RewardGiftModel> mGifts = mGiftPresenter.getCacheData();
...
//                        mTvUserMoney.setTextColor(ContextCompat.getColor(this, R.color.color_FFB446));
//                    } else {
...
////                    return;
////                }
////                mGiftPresenter.sendReward(mGifrModel.getGiftid(), mArticleUId, mObjectType, mObjectId, pId, infoType, 1, title, StringUtils.isEmpty(pw) ? "" : HexUtil.encodeHexStr(MD5Util.md5(pw)));
//            } else {
...
//            }
     ...
     * 初始化gridview
     */
//    private void initGridView(List<RewardGiftBean> mGifts) {
...
//            //存储子列表数据
//            List<RewardGiftBean> mChildList = new ArrayList<>();
...
//
////            RewardGiftAdp giftAdapter = new RewardGiftAdp(this, mChildList);
////            CommonAdapter<RewardGiftModel> mGiftAdp = new CommonAdapter<RewardGiftModel>(aty, mChildList, R.layout.adp_popup_reward) {
////                @Override
////                public void convert(ViewHolder helper, RewardGiftModel item) {
////                    RelativeLayout.LayoutParams ll = new RelativeLayout.LayoutParams(mScreenWidth, mScreenWidth);
////                    RelativeLayout mRootView = (RelativeLayout) helper.getViewById(R.id.id_root_ll);
////                    mRootView.setLayoutParams(ll);
//////                    helper.setImageByUrl(R.id.id_gift_pic_img, item.getImage(), R.color.color_424242);
////                    ImageView iv = (ImageView) helper.getViewById(R.id.id_gift_pic_img);
////                    if (item.imgResourceId != 0) {
////                        iv.setImageDrawable(getResources().getDrawable(item.imgResourceId));
////                    }
////                    TextView mTxtName = (TextView) helper.getViewById(R.id.id_gift_name_txt);
////                    TextView mTxtMoney = (TextView) helper.getViewById(R.id.id_gift_money_txt);
////                    ImageView mCheck = (ImageView) helper.getViewById(R.id.id_check_gift_img);
////                    mTxtName.setText(item.getName());
////                    mTxtMoney.setText(Integer.parseInt(item.getPrice()) / 100 + "元");
////
////                    if (checkMap.get(helper.getPosition(),
////                            false)) {
////                        mCheck.setVisibility(View.VISIBLE);
////                        mTxtName.setTextColor(Color.parseColor("#FDEC7F"));
////                        mTxtMoney.setTextColor(Color.parseColor("#FDEC7F"));
////                    } else {
////                        mCheck.setVisibility(View.GONE);
////                        mTxtName.setTextColor(Color.parseColor("#FFFFFF"));
////                        mTxtMoney.setTextColor(Color.parseColor("#9A9A9A"));
////                    }
////                }
////            };
//            CommonAdapter<RewardGiftModel> mGiftAdp = new CommonAdapter<RewardGiftModel>(aty, mChildList, R.layout.v3_item_transfer_gift) {
//                @Override
//                public void convert(ViewHolder helper, RewardGiftModel item) {
...
//                        rlRoot.setBackgroundResource(R.drawable.shape_ring_blue_bg);
//                    } else {
...
////                                transferModule.id = 0;
////                                Log.d("yeying", "giftActivity " + transferModule.toString());
////                                V3TransferMoneyAty.startV3TransferMoneyAty(V3TransferGiftAty.this, transferModule, isCircle);
////                                finish();
////                            } else {
//////                                transferModule.price = Long.valueOf(mGifrModel.getPrice());
////                            }
