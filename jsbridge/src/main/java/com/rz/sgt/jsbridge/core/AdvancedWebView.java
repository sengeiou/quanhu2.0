...
//                Log.d("webView", "this is onReceivedError " + request.toString());
//
//                setLastError();
//                if (mListener != null) {
...
//            }
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                Log.d("webView", "this is onReceivedError " + failingUrl);
                setLastError();
            ...
            public void onLoadResource(WebView view, String url) {
                Log.d("webView", "this is onLoadResource " + url);
                if (mCustomWebViewClient != null) {
            ...
            public void doUpdateVisitedHistory(WebView view, String url, boolean isReload) {
                ...
                if (mListener != null) {
                    mListener.doUpdateVisitedHistory();
                }
            }
...
//            }
        ...
        super.setWebChromeClient(new WebChromeClient() {
            ...
            public void onShowCustomView(View view, CustomViewCallback callback) {
                Log.d("webView", "onShowCustomView");
                if (mCustomWebChromeClient != null) {
