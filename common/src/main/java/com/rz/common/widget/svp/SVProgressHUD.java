...
public class SVProgressHUD {
    ...
    public static long DISMISSDELAYED = 2000;
    ...
    public static void showWithStatus(Context context, String string) {
        Log.d("checkShow", "showWithStatus  string  " + string);
        getInstance(context).setMaskType(SVProgressHUDMaskType.Black);
    ...
    private void setMaskType(SVProgressHUDMaskType maskType) {
        ...
        switch (mSVProgressHUDMaskType) {
            ...
            case Gradient:
                // TODO 设置半透明渐变背景
                configMaskType(R.drawable.svp_bg_overlay_gradient, true, false);
                break;
            case GradientCancel:
                // TODO 设置半透明渐变背景
                configMaskType(R.drawable.svp_bg_overlay_gradient, true, true);
                break;
            default:
                break;
        }
    ...
    public static boolean isShowing(Context context) {
        if (mSVProgressHUD == null)
            getInstance(context);
        if (context == null || context != mSVProgressHUD.context || getInstance(context).rootView.getParent() == null)
            return false;
        return true;
//        return getInstance(context).rootView.getParent() != null;
    ...
    public static void dismissImmediately(Context context) {
    ...
    public static void dismissImmediatelyNoAnim(Context context) {
        getInstance(context).dismissImmediately();
    }
