package com.yryz.yunxinim.uikit.contact_selector.viewholder;
...
import com.yryz.yunxinim.uikit.common.ui.ptr.ViewCompat;
...
import com.yryz.yunxinim.uikit.contact.core.viewholder.AbsContactViewHolder;
    ...
    public void refresh(ContactDataAdapter adapter, int position, ContactItem item) {
        if (multi) {
            ...
            if (disabled) {
                ...
                this.select.setBackgroundResource(R.drawable.ic_pay_checked);
            } else {
                ViewCompat.setBackground(getView(), defaultBackground);
                this.select.setBackgroundResource(R.drawable.ic_pay_unchecked);
            }
        } else {
