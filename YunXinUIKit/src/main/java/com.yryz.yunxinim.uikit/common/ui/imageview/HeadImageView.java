package com.yryz.yunxinim.uikit.common.ui.imageview;
...
public class HeadImageView extends CircleImageView {
    ...
    public void loadTeamIconByTeam(final Team team) {
        ...
        if (team.getType() == TeamTypeEnum.Advanced)
            setImageResource(R.drawable.ic_default_avatar_team);
        else
            setImageResource(R.drawable.ic_default_avatar_team_normal);
        // 判断是否需要ImageLoader加载
