...
import com.yryz.yunxinim.uikit.common.util.ColorUtil;
...
public class CircleSwitchButton extends CompoundButton {
	...
	public static final int DEFAULT_TINT_COLOR = 0x04b5ab;
	...
	public CircleSwitchButton(Context context, AttributeSet attrs, int defStyle) {
