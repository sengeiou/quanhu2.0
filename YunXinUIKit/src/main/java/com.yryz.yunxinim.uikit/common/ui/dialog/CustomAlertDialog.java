package com.yryz.yunxinim.uikit.common.ui.dialog;
...
public class CustomAlertDialog extends AlertDialog {
    ...
    private int defaultColor = R.color.color_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.easy_dialog_cancel).setOnClickListener(new View.OnClickListener() {
            @Override
