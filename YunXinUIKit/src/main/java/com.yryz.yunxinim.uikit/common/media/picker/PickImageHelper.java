package com.yryz.yunxinim.uikit.common.media.picker;

import android.app.Activity;
import android.content.Context;

import com.yryz.yunxinim.uikit.R;
import com.yryz.yunxinim.uikit.common.media.picker.activity.PickImageActivity;
...
public class PickImageHelper {
    ...
    public static void pickImage(final Context context, final int requestCode, final PickImageOption option) {
        ...
        dialog.addItem(context.getString(R.string.input_panel_take), R.color.color_main, new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
        ...
        dialog.addItem(context.getString(R.string.choose_from_photo_album), R.color.color_main, new CustomAlertDialog
