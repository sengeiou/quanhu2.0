...
public class AdvancedTeamMemberInfoActivity extends UI implements View.OnClickListener {
            ...
            if (key.equals(KEY_MUTE_MSG)) {
                NIMClient.getService(TeamService.class).muteTeamMember(teamId, account, checkState).setCallback(new RequestCallback<Void>() {
                    ...
                    public void onSuccess(Void param) {
                        if (checkState) {
                            Toast.makeText(AdvancedTeamMemberInfoActivity.this, R.string.team_prohibited_words_success, Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(AdvancedTeamMemberInfoActivity.this, R.string.team_prohibited_words_cancel, Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void showUserInfo() {
        Intent intent = new Intent(FRIEND_INFO_ACTION);
        intent.putExtra("key_id", account);
