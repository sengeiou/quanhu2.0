...
import com.yryz.yunxinim.uikit.common.media.picker.PickImageHelper;
...
import com.yryz.yunxinim.uikit.common.ui.dialog.MenuDialog;
...
import com.yryz.yunxinim.uikit.contact.core.item.ContactIdFilter;
...
import com.yryz.yunxinim.uikit.team.ui.TeamInfoGridView;
...
import static com.yryz.yunxinim.uikit.Constants.QUIT_ADVANCE_TEAM;
...
public class AdvancedTeamInfoActivity extends UI implements
    ...
    private Button quitOrDismissBtn;
    // 邀请他人权限
    ...
    private void findViews() {
            ...
            public void onClick(View v) {
                if (team.getTeamUpdateMode() == TeamUpdateModeEnum.Manager) {
                    if (isSelfAdmin || isSelfManager)
                        showSelector(R.string.select_image, REQUEST_PICK_ICON);
                    else
                        Toast.makeText(AdvancedTeamInfoActivity.this, R.string.permission_denied, Toast.LENGTH_SHORT).show();
                } else {
                    showSelector(R.string.select_image, REQUEST_PICK_ICON);
                }
            }
        ...
        quitOrDismissBtn = (Button) findViewById(R.id.quit_team);
        ...
        chatRecordLabel.setText(R.string.chat_record);
        ...
        clearLabel.setText(R.string.clear_local_chat_record);
        ...
        layoutTransfer = findViewById(R.id.team_transfer_layout);
        ((TextView) layoutTransfer.findViewById(R.id.item_title)).setText(R.string.transfer_team);
    ...
    private void initNotify() {
        ...
        ((TextView) layoutNotificationConfig.findViewById(R.id.user_profile_title)).setText(R.string.team_notification_config);
        switchButton = (SwitchButton) layoutNotificationConfig.findViewById(R.id.user_profile_toggle);
    ...
    private void updateTeamInfo(final Team t) {
        ...
        if (team == null) {
            ...
            setTitle(getString(R.string.team_setting));
//            setTitle(team.getName() + "(" + team.getMemberCount() + ")");
        }
        ...
        switchButton.setCheck(!team.mute());
        memberCountText.setText(String.format(getString(R.string.team_member_num_1), team.getMemberCount()));
    ...
    private void updateTeamMemberDataSource() {
        ...
        // refresh
        adapter.notifyDataSetChanged();
        memberCountText.setText(String.format(getString(R.string.team_member_num_1), count));
    }
...
//        NimUIKit.startContactSelect(AdvancedTeamInfoActivity.this, option, REQUEST_CODE_CONTACT_SELECT);
    ...
    private void onTransferTeam() {
        ...
        option.title = getString(R.string.choose_new_team_owner);
        ...
        includeAccounts.remove(creator);
    ...
    private void inviteMembers(ArrayList<String> accounts) {
        NIMClient.getService(TeamService.class).addMembers(teamId, accounts).setCallback(new RequestCallback<Void>() {
            @Override
            public void onSuccess(Void param) {
                Toast.makeText(AdvancedTeamInfoActivity.this, R.string.add_team_member_success1, Toast.LENGTH_SHORT).show();
            }
...
//            return;
//        }
//        Http.getNewService(ImService.class).transferTeam(NimUIKit.getAccount(), teamId, account).enqueue(new Callback<ResponseData>() {
//            @Override
...
//                Toast.makeText(AdvancedTeamInfoActivity.this, R.string.team_transfer_failed, Toast.LENGTH_SHORT).show();
//                Log.e(TAG, "team transfer failed, code=");
//            }
//        });
//    }
    ...
    private void transferTeam(final String account) {
        TeamMember member = TeamDataCache.getInstance().getTeamMember(teamId, account);
        if (member == null) {
            Toast.makeText(AdvancedTeamInfoActivity.this, R.string.member_no_exist, Toast.LENGTH_SHORT).show();
            return;
        }
        if (member.isMute()) {
            Toast.makeText(AdvancedTeamInfoActivity.this, R.string.team_desc_info_1, Toast.LENGTH_LONG).show();
            return;
        }
...
//        Http.getNewService(ImService.class).quitTeam(NimUIKit.getAccount(), teamId).enqueue(new BaseCallback<ResponseData>() {
//            @Override
//            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
//                super.onResponse(call, response);
...
//    }
    ...
    private void showRegularTeamMenu() {
        if (isSelfAdmin) {
            ...
            quitOrDismissBtn.setText(getString(R.string.dismiss_team));
            quitOrDismissBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    dismissTeam();
                }
            ...
            quitOrDismissBtn.setText(getString(R.string.quit_team));
            quitOrDismissBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    quitTeam();
    ...
    private void removeMember(String account) {
        ...
        memberCountText.setText(String.format(getString(R.string.team_member_num_1), members.size()));
...
//                    Http.getNewService(ImService.class).updateTeam(NimUIKit.getAccount(), teamId, null, url, null, null).enqueue(new Callback<ResponseData>() {
//                        @Override
//                        public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
//                            DialogMaker.dismissProgressDialog();
//                            if (response.isSuccessful() && response.body().isSuccessful()) {
...
//                                Toast.makeText(AdvancedTeamInfoActivity.this, R.string.update_success, Toast.LENGTH_SHORT).show();
//                            } else {
//                                Toast.makeText(AdvancedTeamInfoActivity.this, response.body().getMsg(), Toast.LENGTH_SHORT).show();
//                            }
//                        }
//
//                        @Override
...
//                            Toast.makeText(AdvancedTeamInfoActivity.this, "保存失败", Toast.LENGTH_SHORT).show();
//                        }
//                    });
//                } else {
...
//    }
    ...
    private void clearMessage() {
        EasyAlertDialogHelper.createOkCancelDiolag(this, null, getString(R.string.emptied_confirm), true, new EasyAlertDialogHelper.OnDialogActionListener() {
            @Override
            ...
            public void doOkAction() {
                ...
                Toast.makeText(AdvancedTeamInfoActivity.this, R.string.emptied_success, Toast.LENGTH_SHORT).show();
            }
        }).show();
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.settings_chat_record_search) {
            ...
            intent.putExtra("EXTRA_DATA_ACCOUNT", teamId);
