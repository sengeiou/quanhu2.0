...
import com.yryz.yunxinim.uikit.common.media.audioplayer.Playable;
...
public class MsgViewHolderAudio extends MsgViewHolderBase {
    ...
    private void layoutByDirection() {
        ...
        if (isReceivedMessage()) {
            ...
            params.setMargins(0, 0, String.valueOf(duration).length() * view.getContext().getResources().getDimensionPixelOffset(R.dimen.px14), 0);
            ...
            FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) containerView.getLayoutParams();
            params.setMargins(String.valueOf(duration).length() * view.getContext().getResources().getDimensionPixelOffset(R.dimen.px14), 0, 0, 0);
            containerView.setLayoutParams(params);
