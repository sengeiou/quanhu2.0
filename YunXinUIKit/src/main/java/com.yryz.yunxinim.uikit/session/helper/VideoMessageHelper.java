...
import com.yryz.yunxinim.uikit.common.util.C;
import com.yryz.yunxinim.uikit.common.util.file.AttachmentStore;
...
import com.yryz.yunxinim.uikit.common.util.string.MD5;
import com.yryz.yunxinim.uikit.common.util.string.StringUtil;
import com.yryz.yunxinim.uikit.session.activity.CaptureVideoActivity;
...
public class VideoMessageHelper {
    ...
    public void showVideoSource(int local, int capture) {
        ...
        dialog.addItem(activity.getString(R.string.shoot_video),new CustomAlertDialog.onSeparateItemClickListener(){
            @Override
            public void onClick() {
                chooseVideoFromCamera();
            }
        });
        dialog.addItem(activity.getString(R.string.choose_video_from_album),new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
