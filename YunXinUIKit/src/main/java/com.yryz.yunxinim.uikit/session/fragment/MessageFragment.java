...
import com.yryz.yunxinim.uikit.session.actions.ImageAction;
import com.yryz.yunxinim.uikit.session.actions.LocationAction;
import com.yryz.yunxinim.uikit.session.actions.VideoAction;
import com.yryz.yunxinim.uikit.session.constant.Extras;
import com.yryz.yunxinim.uikit.session.module.Container;
import com.yryz.yunxinim.uikit.session.module.ModuleProxy;
import com.yryz.yunxinim.uikit.session.module.input.InputPanel;
import com.yryz.yunxinim.uikit.session.module.list.MessageListPanel;
