...
import com.yryz.yunxinim.avchat.activity.AVChatSettingsActivity;
import com.yryz.yunxinim.config.preference.Preferences;
import com.yryz.yunxinim.config.preference.UserPreferences;
import com.yryz.yunxinim.contact.activity.UserProfileSettingActivity;
import com.yryz.yunxinim.jsbridge.JsBridgeActivity;
import com.yryz.yunxinim.main.adapter.SettingsAdapter;
import com.yryz.yunxinim.main.model.SettingTemplate;
import com.yryz.yunxinim.main.model.SettingType;
...
//                com.yryz.yunxinim.uikit.UserPreferences.isEarPhoneModeEnable()));
    ...
    public void onSwitchChange(SettingTemplate item, boolean checkState) {
        switch (item.getId()) {
            case TAG_NOTICE:
                ...
                break;
            case TAG_SPEAKER:
                com.yryz.yunxinim.uikit.UserPreferences.setEarPhoneModeEnable(checkState);
