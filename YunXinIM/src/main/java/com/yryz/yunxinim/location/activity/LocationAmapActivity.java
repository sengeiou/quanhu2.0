package com.yryz.yunxinim.location.activity;
...
import com.yryz.yunxinim.location.helper.NimGeocoder;
import com.yryz.yunxinim.location.helper.NimLocationManager;
import com.yryz.yunxinim.location.helper.NimLocationManager.NimLocationListener;
...
//	private static final String TAG = "LocationAmapActivity";
    ...
    private String getStaticMapUrl() {
    	StringBuilder urlBuilder = new StringBuilder(com.yryz.yunxinim.location.activity.LocationExtras.STATIC_MAP_URL_1);
    	urlBuilder.append(latitude);
    	urlBuilder.append(",");
    	urlBuilder.append(longitude);
    	urlBuilder.append(com.yryz.yunxinim.location.activity.LocationExtras.STATIC_MAP_URL_2);
