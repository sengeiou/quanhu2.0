        ...
        try {
            ...
            switch (type) {
                ...
                case CustomAttachmentType.LINK:
                    ...
                    break;
                case CustomAttachmentType.Article:
                    attachment = new ArticleAttachment();
                    break;
                case CustomAttachmentType.Show:
                    attachment = new ShowAttachment();
                    break;
                case CustomAttachmentType.Lucky:
                    attachment = new LuckyAttachment();
                    break;
                case CustomAttachmentType.LuckyTip:
                    attachment = new LuckyTipAttachment();
                    break;
                default:
