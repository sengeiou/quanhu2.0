package com.yryz.yunxinim.contact.activity;
...
import com.yryz.yunxinim.contact.constant.UserConstant;
import com.yryz.yunxinim.contact.helper.UserUpdateHelper;
import com.yryz.yunxinim.main.model.Extras;
...
public class UserProfileSettingActivity extends UI implements View.OnClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == PICK_AVATAR_REQUEST) {
            String path = data.getStringExtra(com.yryz.yunxinim.uikit.session.constant.Extras.EXTRA_FILE_PATH);
            updateAvatar(path);
        }
    }
